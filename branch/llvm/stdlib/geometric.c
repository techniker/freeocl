...
__float _Z10half_rsqrtf(__float);
...
__float  _Z14fast_normalizef(const __float p)	{	return _Z10half_rsqrtf(_Z3dotff(p,p)) * p;	}
//__float2 _Z14fast_normalizeu2v2f(const __float2 p)	{	return _Z10half_rsqrtf(_Z3dotu2v2fu2v2f(p,p)) * p;	}
//__float3 _Z14fast_normalizeu2v3f(const __float3 p)	{	return _Z10half_rsqrtf(_Z3dotu2v3fu2v3f(p,p)) * p;	}
__float4 _Z14fast_normalizeu2v4f(const __float4 p)	{	return _Z10half_rsqrtf(_Z3dotu2v4fu2v4f(p,p)) * p;	}

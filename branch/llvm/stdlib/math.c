...
__float _Z5acospif(__float x)	{	return acos(x) / (__float)M_PI;	}
__float _Z4asinf(__float x)	{	return asinf(x);	}
__float _Z5asinhf(__float x)	{	return asinhf(x);	}
__float _Z6asinpif(__float x)	{	return asin(x) / (__float)M_PI;	}
...
__float _Z6atanpif(__float x)	{	return atan(x) / ((__float)M_PI);	}
__float _Z7atan2piff(__float y, __float x)	{	return atan2(y, x) / ((__float)M_PI);	}
...
__float _Z5cospif(__float x)	{	return cos(((__float)M_PI) * x);	}

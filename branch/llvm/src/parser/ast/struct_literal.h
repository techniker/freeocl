...
*/
#ifndef __FREEOCL_PARSER_STRUCT_LITERAL_H__
#define __FREEOCL_PARSER_STRUCT_LITERAL_H__
...
namespace FreeOCL
{
	...
	{
	public:
		struct_literal(const smartptr<type> &p_type, const smartptr<node> &initializer);

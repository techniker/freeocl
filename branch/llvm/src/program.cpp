...
extern "C"
{
										  ...
										  cl_int *errcode_ret)
	{
		...
		//! \todo implement programs from binary
...
//		return program;
						   ...
						   void *user_data)
	{
		...
		FreeOCL::vm *p_vm = FreeOCL::build_program(options ? options : std::string(),
												   source_code,
												   build_log,
												   kernel_names,
												   b_valid_options,
...
//			}
		...
		case CL_PROGRAM_NUM_KERNELS:
			if (!program->handle && !program->p_vm)
